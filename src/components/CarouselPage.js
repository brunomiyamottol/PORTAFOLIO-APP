        ...
        <Carousel
          ...
          <CarouselInner>
            <CarouselItem itemId="1">
              <View>
                <img className="d-block w-100" src="/images/animal-aquatic-close-up-837500.jpg" alt="First slide" />
            ...
            <CarouselItem itemId="2">
              <View>
                <img className="d-block w-100" src="/images/beautiful-view-conifer-daylight1174182_v1.jpg" alt="Second slide" />
